...
<div class="card p-4   ">
    <div class="card-body">
      <h3 >Documentos Normativos | Editar </h3>
      <hr>
          <div class="mt-4" >
            {!! Form::model($documentos_normativo,['route'=>['admin.documentos-normativos.listado.update',$documentos_normativo],'method'=>'put','files'=>true]) !!}
          ...
          <div>
            ...
            <div class="col">
              <div >
                {!! Form::label('fecha', 'Fecha almacenada') !!} 
                <p class="float-end">{{$documentos_normativo->fecha}}</p>
            ...
            <div class="row ">
                ...
                <div class="col-12 order-2 col-sm-6 order-sm-1">
                    <div class=" ratio ratio-21x9">
                        <embed id="vista-previa" class="mt-2" src="{{Storage::url($documentos_normativo->url)}}"  type="application/pdf"> 
                    </div>
                </div>
