...
<div class="card p-4   ">
    <div class="card-body">
      <h3 >Publicaciones | Editar </h3>
      <hr>
          <div class="mt-4" >
            {!! Form::model($publicacione,['route'=>['admin.publicaciones.inicio.update',$publicacione],'files'=>true,'method'=>'put']) !!}
            ...
            <div class="row ">
                ...
                <div class="col-12 order-2 col-sm-6 order-sm-1">
                    <div class=" ratio ratio-21x9">
                      ...
                      <img id="vista-previa" src="{{Storage::url($publicacione->image->url)}}" class="mt-2"  > 
                      @else
                ...
                {!! Form::submit('Aplicar cambios', ['class'=>'btn btn-success btn-lg mt-4']) !!}
