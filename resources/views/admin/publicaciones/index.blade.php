...
<div class="card p-4   ">
    <div class="card-body">
      <h3 >Publicaciones | Listado  </h3>
      <hr>
      <a href="{{route('admin.publicaciones.inicio.create')}}" class="btn btn-success  mt-2 mb-4 " >Añadir +</a>
                ...
                <table id="example" class="table  table-hover text-center  ">
                    ...
                    <tbody>
                        ...
                        @foreach ($posts as $item)
                            ...
                            <td>{{$item->categoria_publicaciones->nombre}}</td> 
                            <td>{{$item->fecha}}</td>
                            ...
                            <td width="10px"   class="pe-1"  >
                                 ...
                                 <a class="btn  btn-sm" href="{{route('admin.publicaciones.inicio.edit',$item)}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                  
                               
                            </td>
                            <td width="10px"   class="ps-1" >
                                <form class="formulario-eliminar" action="{{route('admin.publicaciones.inicio.destroy',$item)}}" method="POST">
                                    @csrf
                                    @method('delete')
