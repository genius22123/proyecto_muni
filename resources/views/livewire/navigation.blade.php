              ...
              <div class="col-8  ">
                    <div class="row   ">
                     ...
                     <div class="col-12  d-flex    justify-content-end  "  >
                        ...
                        <div class="p-2 pe-3 d-none d-md-flex"   style="background-color: #18a5d1;" >
                        <a href="">
                          <img src="{{asset('theme/img/logo-portal-transparencia-ch.png')}}" alt="" width="70">
                        </a>
                      </div>
                  </div>
                      <div class="col-12  d-flex   justify-content-end   ">
      ...
      <div class="container d-flex align-items-center justify-content-center">
        ...
        <nav id="navbar" class="navbar shadow-0 ">
          <ul class="">
            ...
            <li class="dropdown {{request()->routeIs('gestion-municipal')? 'active' : ''}}"><a href="#"><span>Gestion municipal</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
          
            @foreach ($gestion_documentos as $item)
                  <li><a href="{{route('gestion-municipal',$item)}}" >{{$item->titulo}}</a></li>
              @endforeach 
            ...
            <li class="dropdown {{request()->routeIs('normativa-municipal')? 'active' : ''}}"><a href="#"><span>Normativa municipal</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
            
                   @foreach ($categoria_documentos as $item)
                        <li><a href="{{route('normativa-municipal',$item)}}">{{$item->nombre}}</a></li>
                  @endforeach
              
        
              </ul>
            </li>
            <li><a class="nav-link scrollto  {{request()->routeIs('publicaciones*')? 'active' : ''}}" href="{{route('publicaciones')}}">Publicaciones</a></li>
